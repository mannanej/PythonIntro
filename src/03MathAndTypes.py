...
#         HINT: You will need to import the   math  module (library). Eddie added it to the very top of the file for you. Go look at it.
#               You usually want to keep all your imports at the VERY TOP of the file. Imports only need to be added to a file once and can be used anywhere.
